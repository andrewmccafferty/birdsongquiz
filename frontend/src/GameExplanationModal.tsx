  ...
  return (
    <div className="modal" onClick={handleOverlayClick}>
      <div className="modal-box">
        ...
        <p>
          You start by picking two or more species that you find difficult to
          distinguish
        </p>
        <p>
          If you like, you can also specify you want songs or calls (e.g. try
          out Robin vs Hawfinch calls)
        </p>
        <p>
        ...
        <p>
          You'll be asked which species you think it is, and the quiz will tell
          you if you're right. You get 5 "lives" and the quiz will keep going
          until you run out of lives. See how far you can get!
        </p>
        <p>
          If you don't want to go to the bitter end, you can hit the "Reset
          Quiz" button to start again.
        </p>
        <p>
          The data on Xeno-Canto is user-generated, so will sometimes be tagged
          incorrectly (e.g. a sound type tagged as call when it's song or vice
          versa), or include poor-quality recordings!
        </p>
        <p>
